...
const ServerCleanCache = React.createClass({
  ...
  handleSubmit(){
    ...
    Ajax.post('/admins/servers/clean_cache', {server: server.server}, function(jsonData){
  ...
  render(){
    ...
    return (
      <div>
        <Modal 
          title={I18n.getText('server.clean.cache')}
          ...
          <I18nText code="server.clean.cache.confirm" args={[server.server]} />
        </Modal>
      </div>
    );
  }
...
ServerCleanCache.propTypes = {
  server: React.PropTypes.object.isRequired
};

export default ServerCleanCache;